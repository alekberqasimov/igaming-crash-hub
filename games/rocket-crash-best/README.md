# Rocket Crash Best v1.6

Production-test/demo crash game for the IGAMING CRASH HUB.

## Runtime architecture
- Fixed reference math profile: 97% theoretical RTP / 3% theoretical house edge.
- Browser CSPRNG reference implementation for the static demo.
